...
export const VolumeOffIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props
) => (
  <svg
    {...props}
...
export const FullscreenEnterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props
) => (
  <svg
    {...props}
    ...
    strokeLinejoin="round"
  >
    <path d="M4 14h6m-6 0v6m0-6L14 4m-4 0h6m0 0v6" />
  </svg>
);

export const FullscreenExitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props
) => (
  <svg
    {...props}
    ...
    strokeLinejoin="round"
  >
    <path d="M10 4H4v6m6-6l-8 8m14 2h6m-6 0v-6m6 6l-8-8" />
  </svg>
);
